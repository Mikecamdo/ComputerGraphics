...
window.onload = function init() {
    ...
    programRedLines = initShaders(gl, "vertex-shader-lines", "fragment-shader-red");
   ...
   // gl.uniformMatrix4fv( gl.getUniformLocation(program, "uProjectionMatrix"), false, flatten(projectionMatrix));
    ...
    gl.useProgram(programRedLines);
    gl.uniformMatrix4fv( gl.getUniformLocation(programRedLines, "uProjectionMatrix"), false, flatten(projectionMatrix));
...
var render = function() {
    ...
    // Uniforms are shared between vertex and fragment shaders wihtin a program object, but not across programs object

    gl.useProgram(program);
    gl.uniformMatrix4fv( gl.getUniformLocation(program, "uModelViewMatrix"), false, flatten(modelViewMatrix));

    gl.useProgram(programRedLines);
    gl.uniformMatrix4fv( gl.getUniformLocation(programRedLines, "uModelViewMatrix"), false, flatten(modelViewMatrix));
